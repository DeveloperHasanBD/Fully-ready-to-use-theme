 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme urban
...
function customtd_register_required_plugins()
{
	...
	$plugins = array(
		...
		// 	'name' => 'urban Software',
		// 	'slug' => 'urban-software',
		// 	'source' => get_theme_file_path() . '/plugins/urban-software.zip',
		// 	'required' => true,
		// ),
		array(
			'name' => 'CPT',
	 ...
	 */
	$config = array(
		'id'           => 'urban',                 // Unique ID for hashing notices for multiple instances of TGMPA.
