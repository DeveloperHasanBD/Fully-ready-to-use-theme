		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-12 col-md-12 col-lg-2 col-xl-2">
					<div class="hm_logo">
						<?php
						if (get_theme_mod('airport_header_logo_display', true)) {
							$airport_header_normal_logo = get_theme_mod('airport_header_normal_logo');
						?>
							<a href=""><img src="<?php echo $airport_header_normal_logo; ?>" alt=""></a>
						<?php
						}
						?>
					</div>
